...
def save_and_close_book(
    wb, file_path: str | None = None, save_flag: bool = False
):
...
def read_sheet(wb, sheet_name: str | None = None):
    """指定したExcel Sheetを開く"""
...
def read_cell(ws, row: int, column: int, for_database=False) -> str | None:
    """cellの値を取得する"""
